...
CREATE TABLE "BookshelfBooks" (
    "BOOKSHELF_BOOKS_ID" SERIAL NOT NULL,
    "BOOKSHELF_ID" INTEGER NOT NULL,
    "BOOK_ID" INTEGER NOT NULL,
    "STOCK" INTEGER NOT NULL,

    CONSTRAINT "BookshelfBooks_pkey" PRIMARY KEY ("BOOKSHELF_BOOKS_ID")
);
...
CREATE TABLE "History" (
    ...
    "START_DATE" TIMESTAMP(3) NOT NULL,
    "RETURN_DATE" TIMESTAMP(3) NOT NULL,
    "BORROWING_TIME" TEXT NOT NULL,

    CONSTRAINT "History_pkey" PRIMARY KEY ("HISTORY_ID")
);

-- AddForeignKey
ALTER TABLE "BookshelfBooks" ADD CONSTRAINT "BookshelfBooks_BOOKSHELF_ID_fkey" FOREIGN KEY ("BOOKSHELF_ID") REFERENCES "Bookshelf"("BOOKSHELF_ID") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "BookshelfBooks" ADD CONSTRAINT "BookshelfBooks_BOOK_ID_fkey" FOREIGN KEY ("BOOK_ID") REFERENCES "Books"("BOOK_ID") ON DELETE RESTRICT ON UPDATE CASCADE;
